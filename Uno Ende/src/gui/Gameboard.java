...
import model.Player;
import gui.PlayerNameChoose;
import model.Stack;
import model.BackGroundPane;
...
public class Gameboard extends JFrame {
	...
	private BackGroundPane mainPanel;
	...
	private ImageIcon centerIcon2 = new ImageIcon("images/cardstack.png");
	...
	public JPanel createMainPanel() {
		image = Toolkit.getDefaultToolkit().getImage("images/grüner Hintergrund.PNG");
		mainPanel = new BackGroundPane(new BorderLayout());
	...
	private void componentsSettings() {
		...
		playerNames.elementAt(0).setFont(new Font("Dialog", Font.BOLD, 30));
		playerNames.elementAt(0).setForeground(Color.white);
		playerNames.elementAt(1).setFont(new Font("Dialog", Font.BOLD, 30));
		playerNames.elementAt(1).setForeground(Color.white);
		playerNames.elementAt(2).setFont(new Font("Dialog", Font.BOLD, 30));
		playerNames.elementAt(2).setForeground(Color.white);
		playerNames.elementAt(3).setFont(new Font("Dialog", Font.BOLD, 30));
	...
	private JPanel createPlayerSouthPanel(boolean opaque) {
		...
		panel.setOpaque(opaque);
		panel.add(playercardsPanel.elementAt(2));
		panel.add(playernameSouthPanel);
